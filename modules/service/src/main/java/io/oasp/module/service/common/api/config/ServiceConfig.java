package io.oasp.module.service.common.api.config;
...
/**
 * Configuration for {@link io.oasp.module.service.common.api.client.ServiceClientFactory} and all related
 * implementations.
 *
...
public interface ServiceConfig {
  ...
  /** The key segment for the URL of a {@link io.oasp.module.service.common.api.Service}. */
  String KEY_SEGMENT_URL = "url";

  /** The key segment for the port of a {@link io.oasp.module.service.common.api.Service}. */
  String KEY_SEGMENT_PORT = "port";

  /** The key segment for the host of a {@link io.oasp.module.service.common.api.Service}. */
   ...
   *         {@link io.oasp.module.service.common.api.client.ServiceClientFactory} and all related implementations.
   */
